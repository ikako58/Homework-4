...
button1.addEventListener("mouseover" , ()=>{
  button1.style.border = "solid 2px #23A6F0"
  button1.style.backgroundColor = "#252B42"
  button1.style.color = "#23A6F0"
})
...
button2.style.backgroundColor = '#23A6F0';
...
button2.addEventListener("mouseover" , ()=>{
  button2.style.border = "solid 2px #23A6F0"
...
const window3 = createWindow('white', 'Training Courses', '#737373', 'Screenshot 2023-09-19 163151.png', );
...
lowerDiv.appendChild(window3);
  ...
  window1.addEventListener('mouseover', function() {
    window1.style.backgroundColor = "#23A6F0";
    window1.style.color = "white"
    h4.style.color = "white"
  });
  window2.addEventListener('mouseover', function() {
    window2.style.backgroundColor = "#23A6F0"
    window2.style.color = "white"
    h4.style.color = "white"
  });
  window3.addEventListener('mouseover', function() {
    window3.style.backgroundColor = "#23A6F0"
    window3.style.color = "white"
    h4.style.color = "white"
  });


  window1.addEventListener('mouseout', function() {
    window1.style.backgroundColor = "white";
    window1.style.color = "black"
    h4.style.color = "black"
  });
  window2.addEventListener('mouseout', function() {
    window2.style.backgroundColor = "white"
    window2.style.color = "black"
    h4.style.color = "black"
  });
  window3.addEventListener('mouseout', function() {
    window3.style.backgroundColor = "white"
    window3.style.color = "black"
    h4.style.color = "black"
  });
